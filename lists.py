...
#my_list[number to indicate a postion]

#access our healing potion at index 0
print(potions[0])

#accessing invisibilty at index 1
print(potions[1])

#  accessing  strength at index 2
print(potions[2]) 

#accessing the last position in a list is always -1
# my_list[-1] last item on the list
print(potions[-1])

#python lists are very flexible
# many types can exist an elements in a list
#             0      1        2                3
...
# my_list.append(thing we're adding)
# append will add it to the back of the list
...
#my_list.remove(<thing we are removing>)
